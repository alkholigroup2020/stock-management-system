...
<template>
  <div class="space-y-6">
    ...
    <div class="pb-4 border-b border-[var(--ui-border)]">
      <h2 class="text-2xl font-bold text-[var(--ui-text-highlighted)]">Admin Guide</h2>
        ...
        <div class="p-3 rounded-lg bg-[var(--ui-bg)] border border-[var(--ui-warning)]/30">
          <p class="text-sm text-[var(--ui-warning)] flex items-start gap-2">
            ...
            <span>
              ...
              Operators MUST have at least one location assigned. Supervisors and Admins
        ...
        <div>
          ...
          <ul class="space-y-1 text-sm text-[var(--ui-text-muted)]">
            <li>
              ...
              User cannot log in, but their name remains on historical transactions. This preserves
              the audit trail.
            </li>
            <li>
              <strong>Delete:</strong>
              Permanent removal from the system. Only use if the user was created by mistake and has
              no transactions.
            </li>
          </ul>
        </div>
      ...
      <div v-if="isExpanded('locations')" class="p-4 space-y-4">
        ...
        <div>
          ...
          <ul class="space-y-1 text-sm text-[var(--ui-text-muted)]">
            <li>
              ...
              Production and cooking areas that consume ingredients
            </li>
            <li>
              <strong>Store:</strong>
              Retail or distribution points that issue stock to end users
            </li>
            <li>
              <strong>Central:</strong>
              Main storage facility, typically receives bulk deliveries
            </li>
            <li>
              <strong>Warehouse:</strong>
              Bulk storage for overflow or long-term holding
            </li>
          </ul>
        </div>
        ...
        <div class="p-3 rounded-lg bg-[var(--ui-bg)] border border-[var(--ui-border)]">
          <p class="text-sm text-[var(--ui-text-muted)] flex items-start gap-2">
            ...
            />
            <span>
              Each location has independent stock balances. The same item can have different
              quantities and WAC values at different locations.
            </span>
          </p>
        </div>
      </div>
    ...
    >
      ...
      <div v-if="isExpanded('items')" class="p-4 space-y-4">
        ...
        <p class="text-sm text-[var(--ui-text-muted)]">
          ...
          issues (consuming stock), and transfers (moving stock). Period prices are set per item and
          control variance detection during deliveries.
        </p>
        ...
        <div>
          ...
          <ul class="space-y-1 text-sm text-[var(--ui-text-muted)]">
            <li>
              <strong>Code:</strong>
              Unique identifier (e.g., "RICE-001", "CHICKEN-BREAST")
            </li>
            <li>
              <strong>Name:</strong>
              Descriptive name shown throughout the system
            </li>
            <li>
              <strong>Category:</strong>
              Grouping for reporting and filtering (e.g., "Dry Goods", "Proteins")
            </li>
            <li>
        ...
        <div class="p-3 rounded-lg bg-[var(--ui-bg)] border border-[var(--ui-border)]">
          <p class="text-sm text-[var(--ui-text-muted)] flex items-start gap-2">
            ...
            />
            <span>
              Avoid changing the unit of measure on existing items with stock history. Create a new
              item instead to maintain accurate records.
            </span>
          </p>
        </div>
      </div>
      ...
      <div v-if="isExpanded('suppliers')" class="p-4 space-y-4">
        ...
        <div class="p-3 rounded-lg bg-[var(--ui-bg)] border border-[var(--ui-border)]">
          <p class="text-sm text-[var(--ui-text-muted)] flex items-start gap-2">
            ...
            />
            <span>
              NCRs (Non-Conformance Reports) are linked to suppliers through deliveries, helping
        ...
        <div class="p-3 rounded-lg bg-[var(--ui-bg)] border border-[var(--ui-error)]/30">
          <p class="text-sm text-[var(--ui-error)] flex items-start gap-2">
            ...
            <span>
              ...
              Once a period is opened, prices cannot be changed. Review all prices carefully before
              opening.
            </span>
          </p>
        </div>
      ...
      <div v-if="isExpanded('periodClose')" class="p-4 space-y-4">
        ...
        <div class="p-3 rounded-lg bg-[var(--ui-bg)] border border-[var(--ui-error)]/30">
          <p class="text-sm text-[var(--ui-error)] flex items-start gap-2">
            ...
            <span>
              <strong>Warning:</strong>
              Period close cannot be undone. All locations close simultaneously. Ensure all data is
    ...
    <section class="p-4 rounded-lg bg-[var(--ui-bg-elevated)] border border-[var(--ui-border)]">
      ...
      <ul class="space-y-2 text-sm text-[var(--ui-text-muted)]">
        <li class="flex items-center gap-2">
          ...
          <span>
            <strong>One active period:</strong>
            Close current period before opening the next one
          </span>
        </li>
        <li class="flex items-center gap-2">
          <UIcon name="i-heroicons-lock-closed" class="text-[var(--ui-error)]" />
          <span>
            <strong>Prices lock on open:</strong>
            Set and verify all prices before opening a period
          </span>
        </li>
        <li class="flex items-center gap-2">
          <UIcon name="i-heroicons-x-circle" class="text-[var(--ui-error)]" />
          <span>
            <strong>Cannot undo close:</strong>
            Period close is permanent - verify everything first
          </span>
        </li>
        <li class="flex items-center gap-2">
          <UIcon name="i-heroicons-user-minus" class="text-[var(--ui-info)]" />
          <span>
            <strong>Deactivate, don't delete:</strong>
            Preserve user audit trails by deactivating instead
          </span>
        </li>
        <li class="flex items-center gap-2">
          <UIcon name="i-heroicons-map-pin" class="text-[var(--ui-primary)]" />
          <span>
            <strong>Operators need locations:</strong>
            Always assign at least one location to Operators
          </span>
        </li>
      </ul>
    </section>
