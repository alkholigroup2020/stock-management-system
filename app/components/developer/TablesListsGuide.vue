...
// Active subsection
const activeSubSection = ref("tables-overview");
...
const sections = computed(() => [
  { id: "tables-overview", label: "Tables & Lists Overview", icon: "i-heroicons-table-cells" },
  {
    id: "custom-html-table",
    label: "Custom HTML Table Pattern",
    icon: "i-heroicons-squares-2x2",
  },
  { id: "table-structure", label: "Table Structure & Styling", icon: "i-heroicons-paint-brush" },
  {
    id: "column-definitions",
    label: "Column Definitions",
    icon: "i-heroicons-view-columns",
  },
  { id: "row-actions", label: "Row Actions & Navigation", icon: "i-heroicons-cursor-arrow-rays" },
  {
    id: "pagination-pattern",
    label: "Pagination Pattern",
    icon: "i-heroicons-arrows-right-left",
  },
  { id: "filtering-search", label: "Filtering & Search", icon: "i-heroicons-magnifying-glass" },
  { id: "sorting-pattern", label: "Sorting Pattern", icon: "i-heroicons-arrows-up-down" },
  { id: "loading-empty-states", label: "Loading & Empty States", icon: "i-heroicons-inbox" },
  { id: "grid-card-layout", label: "Grid/Card Layout Pattern", icon: "i-heroicons-squares-plus" },
  { id: "responsive-tables", label: "Responsive Design", icon: "i-heroicons-device-phone-mobile" },
  { id: "best-practices-tables", label: "Best Practices", icon: "i-heroicons-check-badge" },
]);
...
<template>
  <div class="flex h-full">
    ...
    <div class="w-1/5 border-r border-[var(--ui-border)] bg-[var(--ui-bg)] overflow-y-auto">
      <nav class="p-4 space-y-1">
        <button
          v-for="section in sections"
          :key="section.id"
          class="w-full text-left px-3 py-2 rounded-lg transition-colors flex items-center gap-2 cursor-pointer"
          :class="
    ...
    <div class="flex-1 overflow-y-auto">
      <div class="p-8 max-w-5xl">
        ...
        <section v-show="activeSubSection === 'tables-overview'" class="prose-config">
          ...
          <p class="section-description">
            ...
            System. The app uses <strong>custom HTML tables</strong> wrapped in UCard components for
            consistent styling and responsive behavior.
          </p>

          <div class="info-box">
            <div class="flex items-start gap-3">
              <UIcon name="i-heroicons-information-circle" class="text-info text-xl flex-shrink-0" />
              <div>
                <h4 class="text-sm font-semibold text-[var(--ui-text-highlighted)] mb-1">
                  Why Custom HTML Tables?
                </h4>
                <p class="text-sm text-[var(--ui-text-muted)]">
                  The app uses custom HTML <code>&lt;table&gt;</code> elements instead of
                  third-party table components for maximum control over styling, performance, and
                  integration with the Nuxt UI design system. This approach provides full
                  flexibility while maintaining consistency with the UI design tokens.
                </p>
              </div>
            </div>
          </div>
          ...
          <ul class="list-styled">
            <li>
              <strong>Custom HTML tables</strong> with Tailwind CSS v4 styling using design system
              tokens
            </li>
            <li>
              <strong>Clickable rows</strong> for navigation to detail pages
            </li>
            <li>
              <strong>Server-side pagination</strong> with page number controls
            </li>
            <li>
              <strong>Filtering & search</strong> with debounced input
            </li>
            <li>
              <strong>Loading, empty, and error states</strong> for better UX
            </li>
            <li>
              <strong>Responsive design</strong> with column hiding on mobile
            </li>
            <li>
              <strong>Grid/card layouts</strong> as alternative to tables
            </li>
          </ul>

          <h3 class="subsection-heading">Common Use Cases</h3>
          <ul class="list-styled">
            <li><strong>Items page:</strong> HTML table with pagination and stock data</li>
            <li><strong>Suppliers page:</strong> Grid/card layout with search</li>
            <li><strong>Stock Now page:</strong> HTML table with filtering and sorting</li>
            <li><strong>Deliveries/Issues page:</strong> HTML table with status badges</li>
          </ul>
        </section>

        <!-- Custom HTML Table Pattern -->
        <section v-show="activeSubSection === 'custom-html-table'" class="prose-config">
          <h2 class="section-heading">Custom HTML Table Pattern</h2>
          <p class="section-description">
            The standard pattern for displaying tabular data uses custom HTML
            <code>&lt;table&gt;</code> elements wrapped in a UCard component with proper styling
            and structure.
          </p>
          ...
          <ul class="list-styled">
            <li>
              <strong>UCard wrapper:</strong> <code>class="card-elevated"</code> for consistent
              elevation
            </li>
            <li>
              <strong>Body padding:</strong> <code>:ui="{ body: 'p-0' }"</code> removes default
              padding
            </li>
            <li>
              <strong>Overflow container:</strong> <code>overflow-x-auto</code> for horizontal
              scroll on mobile
            </li>
            <li>
              <strong>Table classes:</strong> <code>min-w-full</code> ensures full width,
              <code>divide-y</code> adds row dividers
            </li>
            <li>
              <strong>Header styling:</strong> <code>bg-[var(--ui-bg-elevated)]</code> with
              <code>text-label</code> for uppercase small text
            </li>
            <li>
              <strong>Row hover:</strong> <code>hover:bg-[var(--ui-bg-elevated)]</code> with
          ...
          <div class="warning-box">
            <div class="flex items-start gap-3">
              <UIcon name="i-heroicons-exclamation-triangle" class="text-warning text-xl flex-shrink-0" />
              <div>
                <h4 class="text-sm font-semibold text-[var(--ui-text-highlighted)] mb-1">
                  Important
                </h4>
                <p class="text-sm text-[var(--ui-text-muted)]">
                  Always wrap tables in a UCard with <code>:ui="{ body: 'p-0' }"</code> to remove
                  default padding. The <code>overflow-x-auto</code> div inside ensures horizontal
                  scrolling on mobile without breaking the card layout.
                </p>
              </div>
            </div>
          </div>
        ...
        <section v-show="activeSubSection === 'table-structure'" class="prose-config">
          ...
          <ul class="list-styled">
            <li>
              <strong>Background:</strong> <code>bg-[var(--ui-bg-elevated)]</code> for subtle
              elevation
            </li>
            <li>
              <strong>Text:</strong> <code>text-label</code> utility (uppercase, tracking-wide,
              small size)
            </li>
            <li>
              <strong>Padding:</strong> <code>px-4 py-3</code> for consistent spacing
            </li>
            <li>
              <strong>Alignment:</strong> <code>text-left</code> for text columns,
              <code>text-right</code> for numbers
            </li>
          </ul>
          ...
          <ul class="list-styled">
            <li>
              <strong>Padding:</strong> <code>px-4 py-4</code> for comfortable spacing
            </li>
            <li>
              <strong>Text color:</strong> <code>text-[var(--ui-text)]</code> for primary text,
              <code>text-[var(--ui-text-muted)]</code> for secondary
            </li>
            <li>
              <strong>Whitespace:</strong> <code>whitespace-nowrap</code> for codes/numbers to
              prevent wrapping
            </li>
            <li>
              <strong>Font:</strong> <code>font-mono</code> for codes, <code>font-medium</code> for
              emphasis
            </li>
          </ul>
        ...
        <!-- Column Definitions -->
        <section v-show="activeSubSection === 'column-definitions'" class="prose-config">
          ...
          <ul class="list-styled">
            <li>
              <strong>Code columns:</strong> <code>font-mono</code>, <code>text-sm</code>,
              <code>whitespace-nowrap</code>, left-aligned
            </li>
            <li>
              <strong>Name columns:</strong> <code>text-[var(--ui-text)]</code>, left-aligned,
              allows wrapping
            </li>
            <li>
              <strong>Number columns:</strong> Right-aligned, <code>whitespace-nowrap</code>, use
              formatters
            </li>
            <li>
              <strong>Currency columns:</strong> Right-aligned, <code>font-medium</code> for
              emphasis
            </li>
            <li>
              <strong>Status columns:</strong> Use UBadge with appropriate color variants
            </li>
            <li>
              <strong>Action columns:</strong> Right-aligned, <code>whitespace-nowrap</code>,
          ...
          <div class="info-box">
            <div class="flex items-start gap-3">
              <UIcon name="i-heroicons-device-phone-mobile" class="text-info text-xl flex-shrink-0" />
              <div>
                <h4 class="text-sm font-semibold text-[var(--ui-text-highlighted)] mb-1">
                ...
                <p class="text-sm text-[var(--ui-text-muted)]">
                  ...
                  <code>hidden md:table-cell</code> to hide columns below medium breakpoint.
                </p>
              </div>
            </div>
          </div>
        ...
        <section v-show="activeSubSection === 'row-actions'" class="prose-config">
          ...
          <ul class="list-styled">
            ...
            <li>
              <strong>Clickable cells:</strong> Add <code>cursor-pointer</code> class and
              <code>@click</code> handler
            </li>
            <li>
              <strong>Action buttons:</strong> Use <code>@click.stop</code> to prevent row
              navigation
            </li>
            <li>
              <strong>Button styling:</strong> Use <code>variant="ghost"</code> and
              <code>size="xs"</code> for table actions
            </li>
          </ul>
          ...
          <div class="warning-box">
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <p class="text-sm text-[var(--ui-text-muted)]">
                  Always use <code>@click.stop</code> on action buttons to prevent triggering the
                  row click handler. Without <code>.stop</code>, clicking a button will also
          ...
          <ul class="list-styled">
            <li>
              <strong>Edit:</strong> <code>color="primary"</code>, icon
              <code>i-heroicons-pencil</code>
            </li>
            <li>
              <strong>Delete:</strong> <code>color="error"</code>, icon
              <code>i-heroicons-trash</code>
            </li>
            <li>
              <strong>View:</strong> <code>color="neutral"</code>, icon
              <code>i-heroicons-eye</code>
            </li>
            <li>
              Always include <code>class="cursor-pointer"</code> on buttons per project guidelines
            </li>
          </ul>
        </section>

        <!-- Pagination Pattern -->
        <section v-show="activeSubSection === 'pagination-pattern'" class="prose-config">
          ...
          <ul class="list-styled">
            <li>
              <strong>Default page size:</strong> 50 items per page (adjust based on data density)
            </li>
            <li>
              <strong>Server-side pagination:</strong> Always paginate on the server for large
              datasets
            </li>
            <li>
              <strong>Reset on filter:</strong> Set <code>page = 1</code> when filters change
            </li>
            <li>
              <strong>Disable buttons:</strong> Use <code>:disabled</code> for prev/next when at
              edges
            </li>
            <li>
              <strong>Show pagination info:</strong> Display "Showing X to Y of Z items" for
              context
            </li>
            <li>
              <strong>Responsive layout:</strong> Stack info and controls on mobile with
        ...
        <!-- Filtering & Search -->
        <section v-show="activeSubSection === 'filtering-search'" class="prose-config">
          ...
          <ul class="list-styled">
            <li>
              <strong>Debounce search:</strong> Use 500ms delay for search input to reduce API
              calls
            </li>
            <li>
              <strong>Reset pagination:</strong> Set <code>page = 1</code> when filters change
            </li>
            <li>
              <strong>UDropdownMenu:</strong> Use for status/category filters with icon and label
            </li>
            <li>
              <strong>Active indicator:</strong> Show <code>active: true</code> on selected filter
              option
            </li>
            <li>
              <strong>Empty filters:</strong> Use <code>null</code> or <code>undefined</code> for
              "All" option
            </li>
            <li>
              <strong>VueUse composables:</strong> Use <code>useDebounceFn</code> or
              <code>refDebounced</code> for debouncing
            </li>
          </ul>
        </section>

        <!-- Sorting Pattern -->
        <section v-show="activeSubSection === 'sorting-pattern'" class="prose-config">
          ...
          <ul class="list-styled">
            <li>
              Add <code>sort</code> and <code>order</code> params to API request:
              <code>?sort=name&amp;order=asc</code>
            </li>
            <li>
              Store sort state: <code>const sort = ref({ field: 'name', order: 'asc' })</code>
            </li>
            <li>Add click handlers to table headers to toggle sort direction</li>
            <li>
              Show sort indicator icon: <code>i-heroicons-chevron-up</code> or
          ...
          <ul class="list-styled">
            <li>
              Use computed property: <code>const sortedItems = computed(() => [...items].sort(...))</code>
            </li>
          ...
          <div class="info-box">
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <p class="text-sm text-[var(--ui-text-muted)]">
                  Use <strong>server-side sorting</strong> for large datasets, paginated tables, or
                  when data changes frequently. Use <strong>client-side sorting</strong> for small,
                  static datasets or when data is already loaded.
                </p>
              </div>
            </div>
          </div>
        ...
        <section v-show="activeSubSection === 'loading-empty-states'" class="prose-config">
          ...
          <ol class="list-styled">
            <li>
              <strong>Loading:</strong> Show <code>&lt;LoadingSpinner&gt;</code> while fetching data
            </li>
            <li>
              <strong>Error:</strong> Show <code>&lt;ErrorAlert&gt;</code> if fetch fails (with
              retry)
            </li>
            <li>
              <strong>Empty:</strong> Show <code>&lt;EmptyState&gt;</code> if no items match
              filters
            </li>
            <li>
              <strong>Data:</strong> Show table/grid only when data is available
            </li>
          </ol>
          ...
          <div class="info-box">
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <p class="text-sm text-[var(--ui-text-muted)]">
                  Use <code>v-if</code> / <code>v-else-if</code> chain to show states in priority
                  order. This ensures only one state is visible at a time and prevents layout shift.
                </p>
              </div>
            </div>
          </div>
          ...
          <ul class="list-styled">
            <li>
              <strong>Loading text:</strong> Include context like "Loading items..." instead of
              generic "Loading"
            </li>
            <li>
              <strong>Error actions:</strong> Always provide a "Retry" button in error states
            </li>
            <li>
              <strong>Empty actions:</strong> Include a CTA (e.g., "Create Item") when appropriate
            </li>
            <li>
              <strong>Empty message:</strong> Be specific about why list is empty (no results vs no
              items exist)
            </li>
          </ul>
        </section>
        ...
        <section v-show="activeSubSection === 'grid-card-layout'" class="prose-config">
          ...
          <ul class="list-styled">
            <li>
              <strong>Grid classes:</strong> Use
              <code>grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3</code> for responsive layout
            </li>
            <li>
              <strong>Card wrapper:</strong> Use <code>class="card-elevated cursor-pointer"</code>
              for clickable cards
            </li>
            <li>
              <strong>Card padding:</strong> Use <code>:ui="{ body: 'p-6' }"</code> for consistent
              spacing
            </li>
            <li>
              <strong>Click handler:</strong> Add <code>@click</code> to entire card for navigation
            </li>
            <li>
              <strong>Action buttons:</strong> Use <code>@click.stop</code> to prevent card
              navigation
            </li>
            <li>
              <strong>Truncate text:</strong> Use <code>truncate</code> or
              <code>line-clamp-2</code> for long text
            </li>
          </ul>
          ...
          <ul class="list-styled">
            <li>
              <strong>Use Grid when:</strong> Items have rich metadata (images, multi-line
              descriptions)
            </li>
            <li>
              <strong>Use Grid when:</strong> Horizontal space is limited (mobile-first design)
            </li>
            <li>
              <strong>Use Grid when:</strong> Visual hierarchy is important (featured items)
            </li>
            <li>
              <strong>Use Table when:</strong> Data is primarily numerical or needs column alignment
            </li>
            <li>
              <strong>Use Table when:</strong> Users need to scan/compare rows quickly
            </li>
            <li>
              <strong>Use Table when:</strong> Sorting/filtering by multiple columns is essential
            </li>
          </ul>
        </section>

        <!-- Responsive Design -->
        <section v-show="activeSubSection === 'responsive-tables'" class="prose-config">
          ...
          <ul class="list-styled">
            <li>
              <strong>Horizontal scroll:</strong> Wrap table in <code>overflow-x-auto</code> div for
              mobile
            </li>
            <li>
              <strong>Hide columns:</strong> Use <code>hidden md:table-cell</code> to hide
              less-important columns
            </li>
            <li>
              <strong>Stack filters:</strong> Use <code>flex-col md:flex-row</code> for filter rows
            </li>
            <li>
              <strong>Reduce padding:</strong> Use responsive classes like <code>px-2 md:px-4</code>
              on mobile
            </li>
            <li>
              <strong>Icon-only buttons:</strong> Show only icons on mobile, add text on larger
              screens
            </li>
            <li>
              <strong>Grid to list:</strong> Change from multi-column grid to single column on
              mobile
            </li>
          </ul>
          ...
          <ul class="list-styled">
            <li>
              <strong>sm (640px):</strong> Reduce button text, show shorter labels
            </li>
            <li>
              <strong>md (768px):</strong> Show secondary columns, expand filters to single row
            </li>
            <li>
              <strong>lg (1024px):</strong> Show tertiary columns, full table layout
            </li>
            <li>
              <strong>2xl (1536px):</strong> Add more grid columns (3-4 columns for cards)
            </li>
          </ul>
        ...
        <!-- Best Practices -->
        <section v-show="activeSubSection === 'best-practices-tables'" class="prose-config">
          <h2 class="section-heading">Best Practices Summary</h2>

          <h3 class="subsection-heading">Table Structure</h3>
          <ul class="list-styled">
            <li>
              ✅ Always wrap tables in <code>&lt;UCard class="card-elevated"&gt;</code> with
              <code>:ui="{ body: 'p-0' }"</code>
            </li>
            <li>
              ✅ Use <code>&lt;div class="overflow-x-auto"&gt;</code> wrapper for horizontal scroll
            </li>
            <li>
              ✅ Add <code>min-w-full</code> to table and <code>divide-y</code> for row separators
            </li>
            <li>
              ✅ Use <code>hover:bg-[var(--ui-bg-elevated)]</code> with
              <code>transition-colors</code> on rows
            </li>
          ...
          <ul class="list-styled">
            <li>
              ✅ Use <code>text-label</code> utility for table headers (uppercase, tracking-wide)
            </li>
            <li>
              ✅ Left-align text columns, right-align number/currency columns
            </li>
            <li>
              ✅ Use <code>font-mono</code> for codes, <code>font-medium</code> for emphasis
            </li>
            <li>
              ✅ Add <code>whitespace-nowrap</code> to prevent text wrapping in code/number columns
            </li>
            <li>
              ❌ Don't use inconsistent padding (stick to <code>px-4 py-3</code> for headers,
              <code>px-4 py-4</code> for cells)
            </li>
          </ul>
          ...
          <ul class="list-styled">
            <li>
              ✅ Add <code>cursor-pointer</code> to clickable rows for visual feedback
            </li>
            <li>
              ✅ Use <code>@click.stop</code> on action buttons to prevent row click propagation
            </li>
            <li>
              ✅ Use <code>variant="ghost"</code> and <code>size="xs"</code> for table action
              buttons
            </li>
            <li>
              ✅ Always include <code>class="cursor-pointer"</code> on all buttons (project
              guideline)
            </li>
            <li>
          ...
          <ul class="list-styled">
            <li>
              ✅ Implement server-side pagination for datasets larger than 100 items
            </li>
            <li>
              ✅ Debounce search input by 500ms to reduce API calls
            </li>
            <li>
              ✅ Reset pagination to page 1 when filters change
            </li>
            <li>
              ✅ Show loading, error, and empty states in proper priority order
            </li>
            <li>
              ✅ Provide retry action on error states
            </li>
            <li>
              ❌ Don't fetch data without loading indicators
            </li>
          </ul>
          ...
          <ul class="list-styled">
            <li>
              ✅ Hide less important columns on mobile using <code>hidden md:table-cell</code>
            </li>
            <li>
              ✅ Keep code, name, and actions visible on all screen sizes
            </li>
            <li>
              ✅ Stack filter controls vertically on mobile (<code>flex-col md:flex-row</code>)
            </li>
            <li>
              ✅ Consider grid/card layout instead of table for mobile-heavy use cases
            </li>
            <li>
              ❌ Don't force horizontal scroll for basic tables (hide columns instead)
            </li>
          </ul>
          ...
          <ul class="list-styled">
            <li>
              ✅ Use <code>v-for</code> with <code>:key="item.id"</code> for efficient updates
            </li>
            <li>
            ...
            <li>
              ✅ Cache table data using useAsyncData or composables
            </li>
            <li>
              ❌ Don't sort/filter large datasets on the client (use server-side instead)
            </li>
          </ul>
            ...
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <ul class="text-sm text-[var(--ui-text-muted)] space-y-1">
                  ...
                  <li>✓ All buttons have <code>cursor-pointer</code> class</li>
                  <li>✓ Action buttons use <code>@click.stop</code> to prevent row navigation</li>
