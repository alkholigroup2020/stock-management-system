...
<template>
  <div class="space-y-6">
    ...
    <div class="pb-4 border-b border-[var(--ui-border)]">
      <h2 class="text-2xl font-bold text-[var(--ui-text-highlighted)]">Page Title</h2>
      <p class="text-sm text-[var(--ui-text-muted)] mt-1">Page subtitle/description</p>
    </div>

    <!-- Section -->
    <section>
      <h3 class="text-lg font-semibold text-[var(--ui-text-highlighted)] mb-3">Section Title</h3>
      <p class="text-sm text-[var(--ui-text-muted)] mb-4">Section description paragraph.</p>
